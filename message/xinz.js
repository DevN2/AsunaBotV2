...
module.exports = async(devn, msg, blocked, baterai, _afk, welcome, left) => {
    try {
        ...
        const botNumber = devn.user.jid
        const groupMetadata = isGroup ? await devn.groupMetadata(from) : ''
        ...
        const reply = (teks) => {
            return devn.sendMessage(from, teks, text, {quoted:msg})
        }
        const sendMess = (hehe, teks) => {
            return devn.sendMessage(hehe, teks, text)
        }
        const mentions = (teks, memberr, id) => {
            let ai = (id == null || id == undefined || id == false) ? devn.sendMessage(from, teks.trim(), extendedText, {contextInfo: {"mentionedJid": memberr}}) : devn.sendMessage(from, teks.trim(), extendedText, {quoted: msg, contextInfo: {"mentionedJid": memberr}})
            return ai
        }
        async function sendFileFromUrl(from, url, caption, msg, men) {
            ...
            return devn.sendMessage(from, await getBuffer(url), type, {caption: caption, quoted: msg, thumbnail: Buffer.alloc(0), mimetype: mime, contextInfo: {"mentionedJid": men ? men : []}})
        }
        const textImg = (teks) => {
            return devn.sendMessage(from, teks, text, {quoted: msg, thumbnail: fs.readFileSync(setting.pathImg)})
        }
        const fakeimage = (teks) => {
               return  devn.sendMessage(from, fs.readFileSync(setting.pathImg), MessageType.image,
                {
                quoted: {
                key: {
                fromMe: false,
     ...
     thumbnail: fs.readFileSync(setting.pathImg)
        ...
        // GAME 
        game.cekWaktuFam(devn, family100)
        game.cekWaktuTG(devn, tebakgambar)
        ...
        if (game.isfam(from, family100) && isUser){
            ...
            if (anjuy.length < 1){
                devn.sendMessage(from, `Semua jawaban sudah tertebak\nKirim *${prefix}family100* untuk bermain lagi`, text)
        ...
        // Auto Read
        devn.chatRead(from, "read")

        // CMD
        if (isCmd && !isGroup) {
			//devn.updatePresence(from, Presence.composing)
...
//------------------< Sticker / Tools >-------------------
            ...
            case prefix+'sgif':{
                ...
                if (isImage || isQuotedImage) {
                    ...
                    let media = await devn.downloadAndSaveMediaMessage(encmedia, `./sticker/${sender}`)
                    await ffmpeg(`${media}`)
							.input(media)
							...
							.on('end', function () {
								...
								exec(`webpmux -set exif ./sticker/data.exif ./sticker/${sender}.webp -o ./sticker/${sender}.webp`, async (error) => {
									...
									devn.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), sticker, {quoted: msg})
            ...
            case prefix+'tomedia':{
                ...
                let encmedia = JSON.parse(JSON.stringify(msg).replace('quotedM','m')).message.extendedTextMessage.contextInfo
				let media = await devn.downloadAndSaveMediaMessage(encmedia)
				if (quotedMsg.stickerMessage.isAnimated === true){
                    ...
                    exec(`convert ${media} ${outGif}`, (err) => {
                        ...
                        exec(`ffmpeg -i ${outGif} -vf "crop=trunc(iw/2)*2:trunc(ih/2)*2" -b:v 0 -crf 25 -f mp4 -vcodec libx264 -pix_fmt yuv420p ${outMp4}`, (err) => {
                            ...
                            devn.sendVideo(from, fs.readFileSync(outMp4), 'Nih', msg)
                            .then(() => {
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						devn.sendMessage(from, fs.readFileSync(ran), image, {quoted: msg, caption: 'NIH'})
                        limitAdd(sender,  limit)
						fs.unlinkSync(ran)
					})
					}
            ...
            case prefix+'attp':{
                ...
                exec(`webpmux -set exif ./sticker/data.exif ./sticker/attp.webp -o ./sticker/attp.webp`, async (error) => {
                    if (error) return reply(mess.error.api)
                    devn.sendMessage(from, fs.readFileSync(`./sticker/attp.webp`), sticker, {quoted: msg})
                    limitAdd(sender, limit)
            ...
            case prefix+'imgtourl':{
                if (isImage || isQuotedImage) {
                    let encmedia = isQuotedImage ? JSON.parse(JSON.stringify(msg).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : msg
                    let media = await devn.downloadMediaMessage(encmedia)
...
//------------------< NULIS >---------------------
            ...
            case prefix+'nuliskiri':{
                ...
                .on('exit', () => {
                    devn.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkiri.jpg'), image, {quoted: msg, caption: `Jangan malas pak...`, thumbnail: Buffer.alloc(0)})
                    limitAdd(sender, limit)
                })
            }
                break
            case prefix+'nuliskanan':{
                ...
                .on('error', () => reply(mess.error.api))
                .on('exit', () => {
                    devn.sendMessage(from, fs.readFileSync('./media/nulis/images/buku/setelahkanan.jpg'), image, {quoted: msg, caption: `Jangan malas pak...`, thumbnail: Buffer.alloc(0)})
                    limitAdd(sender, limit)
                })
            }
                break
            case prefix+'foliokiri':{
                ...
                .on('error', () => reply(mess.error.api))
                .on('exit', () => {
                    devn.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkiri.jpg'), image, {quoted: msg, caption: `Jangan malas pak...`, thumbnail: Buffer.alloc(0)})
                    limitAdd(sender, limit)
                })
            }
                break
            case prefix+'foliokanan':{
                ...
                .on('error', () => reply(mess.error.api))
                .on('exit', () => {
                    devn.sendMessage(from, fs.readFileSync('./media/nulis/images/folio/setelahkanan.jpg'), image, {quoted: msg, caption: `Jangan malas pak...`, thumbnail: Buffer.alloc(0)})
                    limitAdd(sender, limit)
                })
            }
                break
...
//------------------< Text Marker >-------------------
            case prefix+'harta': case prefix+'hartatahta': case prefix+'tahta':{
                ...
                devn.sendImage(from, await getBuffer(`https://api-ramlan.herokuapp.com/api/other/tahta?q=${args[1]}&apikey=${apikey}`), '', msg).catch(() => reply(mess.error.api))
                limitAdd(sender, limit)
                }
                break
//>>> TEXT PRO ME
                ...
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} devn`)
                reply(mess.wait)
                devn.sendImage(from, await getBuffer(`https://api-ramlan.herokuapp.com/api/textpro/${command.slice(1)}?apikey=${apikey}&text=${q}`), '', msg).catch(() => reply(mess.error.api))
                limitAdd(sender, limit)
                }
                    break
                ...
                reply(mess.wait)
                devn.sendImage(from, await getBuffer(`https://api-ramlan.herokuapp.com/api/textpro2/${command.slice(1)}?apikey=${apikey}&text1=${q.split("|")[0]}&text2=${q.split("|")[1]}`), '', msg).catch(() => reply(mess.error.api))
                limitAdd(sender, limit)
                }
                    break
//>>> PHOTOOXY
                ...
                if (args.length < 2) return reply(`Penggunaan ${command} text\n\nContoh : ${command} devn`)
                reply(mess.wait)
                devn.sendImage(from, await getBuffer(`https://api-ramlan.herokuapp.com/api/photooxy/${command.slice(1)}?apikey=${apikey}&text=${q}`), '', msg).catch(() => reply(mess.error.api))
                limitAdd(sender, limit)
                }
                    break
                ...
                if (!q.includes("|")) return reply(`Penggunaan ${command} text1|text2\n\nContoh : ${command} Ramlan|Rara`)
                reply(mess.wait)
                devn.sendImage(from, await getBuffer(`https://api-ramlan.herokuapp.com/api/photooxy/pubglogo?apikey=${apikey}&text1=${q.split("|")[0]}&text2=${q.split("|")[1]}`), '', msg).catch(() => reply(mess.error.api))
                limitAdd(sender, limit)
                }
                    break
//------------------< Math Random >-------------------
				...
				if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} saya wibu`)
					...
					devn.sendMessage(from, 'Pertanyaan : apakah ' + q + '\n\nJawaban : ' + kah, text, { quoted: msg })
					break
				...
				if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} kegantengan saya`)
					...
					devn.sendMessage(from, 'Pertanyaan : ' + q + '\n\nJawaban : ' + te + '%', text, { quoted: msg })
					break
				...
				if (!q) return reply(`Penggunaan ${command} text\n\nContoh : ${command} Rara`)
					...
					devn.sendMessage(from, 'Pertanyaan : hobby ' + q + '\n\nJawaban : ' + by, text, { quoted: msg })
					break
                ...
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
					...
					devn.sendImage(from, await getBuffer(`https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`), 'Truth\n\n' + ttrth, msg)
					break
                ...
                if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
					...
					devn.sendImage(from, await getBuffer(`https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`), 'Dare\n\n' + der , msg)
					break
				case prefix+'cekbapak': // By Ramlan ID
					const bapak = ['Wah Mantap Lu Masih Punya Bapack\nPasti Bapack Nya Kuli :v\nAwowkwokwwok\n#CandabOs', 'Aowkwwo Disini Ada Yteam :v\nLu Yteam Bro? Awowkwowk\nSabar Bro Ga Punya Bapack\n#Camda', 'Bjir Bapack Mu Ternyata Sudah Cemrai\nSedih Bro Gua Liatnya\nTapi Nih Tapi :v\nTetep Ae Lu Yteam Aowkwowkw Ngakak :v', 'Jangan #cekbapak Mulu Broo :v\nKasian Yang Yteam\nNtar Tersinggung Kan\nYahahaha Hayyuk By : Ramlan ID']
					const cek = bapak[Math.floor(Math.random() * bapak.length)]
					devn.sendMessage(from, cek, text, { quoted: msg })
					break
//------------------< Random >---------------------
				case prefix+'quotes':{
...
//------------------< Baileys >---------------------
            ...
            case prefix+'kontak':
                ...
                devn.sendContact(from, q.split("|")[0], q.split("|")[1], msg)
                break
            case prefix+'hidetag':{
...
//------------------< INFO >-------------------
            ...
            case prefix+'owner':
            case prefix+'creator':
                devn.sendContact(from, ownerNumber.split("@")[0], setting.ownerName, msg)
                .then((res) => devn.sendMessage(from, 'Nih kontak ownerku', text, {quoted: res}))
                break
            case prefix+'ping':
            case prefix+'speed':{
                let timestamp = speed();
            ...
            case prefix+'sourcecode': case prefix+'sc': case prefix+'src':
                textImg(`Bot ini menggunakan sc : https://github.com/devn-Team/devnBot`)
                break
            case prefix+'runtime':
            ...
            case prefix+'stats': 
            case prefix+'botstat':{
                let totalchat = await devn.chats.all()
				let i = []
				let giid = []
                ...
                const { wa_version, mcc, mnc, os_version, device_manufacturer, device_model } = devn.user.phone
...
//------------------< Owner >-------------------
            ...
            case prefix+'setpic': case prefix+'setpicbot':{
                ...
                if (isImage || isQuotedImage) {
                    let encmedia = isQuotedImage ? JSON.parse(JSON.stringify(msg).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : msg
                    let media = await devn.downloadMediaMessage(encmedia)
                    devn.updateProfilePicture(devn.user.jid, media)
            ...
            case prefix+'clearall':{
                if (!isOwner) return reply(mess.OnlyOwner)
                let chiit = await devn.chats.all()
                for (let i of chiit){
                    devn.modifyChat(i.jid, 'delete', {
            ...
            case prefix+'setthumb':
                if (!isOwner) return reply(mess.OnlyOwner)
                    ...
                    const downiamgethumb = await devn.downloadMediaMessage(messimagethumb)
            ...
            case prefix+'bc':
                ...
                if (isImage || isQuotedImage) {
                    ...
                    let media = await devn.downloadMediaMessage(encmedia)
                    for (let i of chiit){
                        devn.sendMessage(i.jid, media, image, {caption: q})
                    }
                    reply(`Sukses`)
                    ...
                    let media = await devn.downloadMediaMessage(encmedia)
                    for (let i of chiit){
                        devn.sendMessage(i.jid, media, video, {caption: q})
                    }
                    reply(`Sukses`)
                } else {
                    for (let i of chiit){
                        devn.sendMessage(i.jid, q, text)
                    }
                    reply(`Sukses`)
                }
                break
//------------------< G R U P >-------------------
			...
			case prefix+'d':
				...
				devn.deleteMessage(from, { id: msg.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
				break
            case prefix+'afk':
                if (!isGroup) return reply(mess.OnlyGrup)
            ...
            case prefix+'groupinfo':
                if (!isGroup) return reply(mess.OnlyGrup)
                try {
                    var pic = await devn.getProfilePicture(from)
                } catch {
                ...
                devn.sendMessage(from, await getBuffer(pic), image, {quoted: msg, caption: ingfo, contextInfo: {"mentionedJid": [groupMetadata.owner.replace('@c.us', '@s.whatsapp.net')]}})
                break
            case prefix+'add':
                if (!isGroup) return reply(mess.OnlyGrup)
                if (!isGroupAdmins && !isOwner)return reply(mess.GrupAdmin)
				...
				if (isQuotedMsg && args.length < 2) {
                    devn.groupAdd(from, [quotedMsg.sender])
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else if (args.length < 3 && !isNaN(args[1])){
					devn.groupAdd(from, [args[1] + '@s.whatsapp.net'])
					.then((res) => reply(jsonformat(res)))
					.catch((err) => reply(jsonformat(err)))
				} else {
					reply()
            ...
            case prefix+'kick':
                ...
                if (!isBotGroupAdmins) return reply(mess.BotAdmin)
                if (mentioned.length !== 0){
                    devn.groupRemove(from, mentioned)
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else if (isQuotedMsg) {
                    if (quotedMsg.sender === ownerNumber) return reply(`Tidak bisa kick Owner`)
                    devn.groupRemove(from, [quotedMsg.sender])
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else if (!isNaN(args[1])) {
                    devn.groupRemove(from, [args[1] + '@s.whatsapp.net'])
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else {
            ...
            case prefix+'promote':
                ...
                if (mentioned.length !== 0){
                    ...
                    devn.groupMakeAdmin(from, [quotedMsg.sender])
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else if (!isNaN(args[1])) {
                    devn.groupMakeAdmin(from, [args[1] + '@s.whatsapp.net'])
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else {
            ...
            case prefix+'demote':
                ...
                if (mentioned.length !== 0){
                    ...
                    if (quotedMsg.sender === ownerNumber) return reply(`Tidak bisa kick Owner`)
                    devn.groupDemoteAdmin(from, [quotedMsg.sender])
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else if (!isNaN(args[1])) {
                    devn.groupDemoteAdmin(from, [args[1] + '@s.whatsapp.net'])
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else {
            ...
            case prefix+'setdesc':
                ...
                devn.groupUpdateDescription(from, q)
                .then((res) => reply(jsonformat(res)))
                .catch((err) => reply(jsonformat(err)))
                break
            case prefix+'setgrupname':
                ...
                devn.groupUpdateSubject(from, q)
                .then((res) => reply(jsonformat(res)))
                .catch((err) => reply(jsonformat(err)))
                break
            case prefix+'sider': case prefix+'chatinfo':
                ...
                if (!isQuotedMsg) return reply(`Reply pesan dari bot`)
                if (!quotedMsg.fromMe) return reply(`Reply pesan dari bot`)
                    devn.messageInfo(from, msg.message.extendedTextMessage.contextInfo.stanzaId)
                    .then((res) => {
                        let anu = []
                        let txt = `*Info Chat*\n\n`
            ...
            case prefix+'opengrup':
                ...
                if (!isGroupAdmins && !isOwner)return reply(mess.GrupAdmin)
                if (!isBotGroupAdmins) return reply(mess.BotAdmin)
                devn.groupSettingChange(from, "announcement", false)
                .then((res) => reply(jsonformat(res)))
                .catch((err) => reply(jsonformat(err)))
                break
            case prefix+'closegrup':
                ...
                if (!isGroupAdmins && !isOwner)return reply(mess.GrupAdmin)
                if (!isBotGroupAdmins) return reply(mess.BotAdmin)
                devn.groupSettingChange(from, "announcement", true)
                .then((res) => reply(jsonformat(res)))
                .catch((err) => reply(jsonformat(err)))
                break
            case prefix+'setppgrup':
                ...
                if (isImage || isQuotedImage) {
                    let encmedia = isQuotedImage ? JSON.parse(JSON.stringify(msg).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : msg
                    let media = await devn.downloadMediaMessage(encmedia)
                    devn.updateProfilePicture(from, media)
                    .then((res) => reply(jsonformat(res)))
                    .catch((err) => reply(jsonformat(err)))
                } else {
...
//------------------< Enable / Disable >-------------------
            ...
            case prefix+'sound1':{
                ...
                devn.sendMessage(from, son, audio, { quoted: msg })              
                limitAdd(sender, limit)
                }
                break
            case prefix+'sound2':{
